...
object Colors {
    ...
    val purpleLight = Color(0xFF5E60CE)
    val purpleBright = Color(0xFF8284FA)

    val gray700 = Color(0xFF0D0D0D) // Cinza mais escuro
    val gray600 = Color(0xFF1A1A1A)
    val gray500 = Color(0xFF262626)
    val gray400 = Color(0xFF333333)
